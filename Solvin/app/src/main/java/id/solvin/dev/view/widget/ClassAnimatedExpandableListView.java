 ...
 */
public class ClassAnimatedExpandableListView extends ExpandableListView {
    /*
    ...
    public ClassAnimatedExpandableListView(Context context) {
        super(context);
    }

    public ClassAnimatedExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ClassAnimatedExpandableListView(Context context, AttributeSet attrs, int defStyle) {
...
//        boolean lastGroup = groupPos == adapter.getGroupCount() - 1;                      Default
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private ClassAnimatedExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(ClassAnimatedExpandableListView parent) {
            this.parent = parent;
        }
